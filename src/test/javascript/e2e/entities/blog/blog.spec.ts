...
describe('Blog e2e test', () => {
  ...
  it('should load Blogs', async () => {
    ...
    expect(await blogComponentsPage.getTitle()).to.eq('myappApp.blog.home.title');
  ...
  it('should load create Blog page', async () => {
    ...
    expect(await blogUpdatePage.getPageTitle()).to.eq('myappApp.blog.home.createOrEditLabel');
  ...
  it('should delete last Blog', async () => {
    ...
    expect(await blogDeleteDialog.getDialogTitle()).to.eq('myappApp.blog.delete.question');
