...
describe('Restaurant e2e test', () => {
  ...
  it('should load Restaurants', async () => {
    ...
    expect(await restaurantComponentsPage.getTitle()).to.eq('myappApp.restaurant.home.title');
  ...
  it('should load create Restaurant page', async () => {
    ...
    expect(await restaurantUpdatePage.getPageTitle()).to.eq('myappApp.restaurant.home.createOrEditLabel');
  ...
  it('should create and save Restaurants', async () => {
    ...
    await promise.all([
      ...
      restaurantUpdatePage.compteSelectLastOption(),
    ]);
  ...
  it('should delete last Restaurant', async () => {
    ...
    expect(await restaurantDeleteDialog.getDialogTitle()).to.eq('myappApp.restaurant.delete.question');
