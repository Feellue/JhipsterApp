...
describe('Post e2e test', () => {
  ...
  it('should load Posts', async () => {
    ...
    expect(await postComponentsPage.getTitle()).to.eq('myappApp.post.home.title');
  ...
  it('should load create Post page', async () => {
    ...
    expect(await postUpdatePage.getPageTitle()).to.eq('myappApp.post.home.createOrEditLabel');
  ...
  it('should delete last Post', async () => {
    ...
    expect(await postDeleteDialog.getDialogTitle()).to.eq('myappApp.post.delete.question');
