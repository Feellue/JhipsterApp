...
describe('SystemePaiement e2e test', () => {
  ...
  it('should load SystemePaiements', async () => {
    ...
    expect(await systemePaiementComponentsPage.getTitle()).to.eq('myappApp.systemePaiement.home.title');
    await browser.wait(
  ...
  it('should load create SystemePaiement page', async () => {
    ...
    expect(await systemePaiementUpdatePage.getPageTitle()).to.eq('myappApp.systemePaiement.home.createOrEditLabel');
  ...
  it('should delete last SystemePaiement', async () => {
    ...
    expect(await systemePaiementDeleteDialog.getDialogTitle()).to.eq('myappApp.systemePaiement.delete.question');
