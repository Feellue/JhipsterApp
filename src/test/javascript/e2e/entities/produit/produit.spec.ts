...
describe('Produit e2e test', () => {
  ...
  it('should load Produits', async () => {
    ...
    expect(await produitComponentsPage.getTitle()).to.eq('myappApp.produit.home.title');
  ...
  it('should load create Produit page', async () => {
    ...
    expect(await produitUpdatePage.getPageTitle()).to.eq('myappApp.produit.home.createOrEditLabel');
  ...
  it('should delete last Produit', async () => {
    ...
    expect(await produitDeleteDialog.getDialogTitle()).to.eq('myappApp.produit.delete.question');
